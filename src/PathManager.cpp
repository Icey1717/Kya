...
void CPathFollow::Create(ByteCode* pByteCode)
{
	...
	if ((uVar2 & 8) != 0) {
		...
		this->field_0x2c = reinterpret_cast<float*>(pcVar1);
	}
...
void CPathFollowReaderAbsolute::Create(ByteCode* pByteCode)
{
	...
	//ACTOR_LOG(LogLevel::Info, "CPathFollowReaderAbsolute::Create");
