...
#define INPUT_BUTTON_INDEX_CROSS_ALT	0x18

#define INPUT_BUTTON_INDEX_L1			0x1b
#define INPUT_BUTTON_INDEX_R1_ALT		0x1c
#define INPUT_BUTTON_INDEX_1E			0x1e
#define INPUT_BUTTON_INDEX_SQUARE_ALT	0x1f
...
#define PAD_BITMASK_CROSS_ALT 			(1 << INPUT_BUTTON_INDEX_CROSS_ALT)		// 0x01000000
...
#define PAD_BITMASK_R1_ALT 				(1 << INPUT_BUTTON_INDEX_R1_ALT)		// 0x10000000
#define PAD_BITMASK_15 					(1 << 0x1d)								// 0x20000000
#define PAD_BITMASK_16 					(1 << INPUT_BUTTON_INDEX_1E)			// 0x40000000
#define PAD_BITMASK_SQUARE_ALT 			(1 << INPUT_BUTTON_INDEX_SQUARE_ALT)	// 0x80000000
