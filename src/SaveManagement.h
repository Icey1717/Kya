...
public:
	...
	struct SaveBigAlloc* pBigAlloc_0x34;
	void* pSettings_0x38;
	int gameSaveMaxBufferSize;
	int settingsSize_0x40;
	uint saveSize_0x44;
	char memCardAccessPath[8];
