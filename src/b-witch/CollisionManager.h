...
#define COLLISION_ALL_FLAG   (COLLISION_WALL_FLAG | COLLISION_GROUND_FLAG | COLLISION_CEILING_FLAG)
...
public:
	...
	bool CheckCollisions_RayIntersect(CActor* pActor, edF32VECTOR4* v0, edF32VECTOR4* v1, CActorsTable* pTable, int param_6);
