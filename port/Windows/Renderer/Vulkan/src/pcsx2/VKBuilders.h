...
{
	inline std::string StdStringFromFormatV(const char* format, std::va_list ap)
	{
		std::va_list ap_copy;
		va_copy(ap_copy, ap);
...
namespace Vulkan
{
	...
	public:
		...
		void SetVertexShader(VkShaderModule module, const char* entrypoint) { SetShaderStage(VK_SHADER_STAGE_VERTEX_BIT, module, entrypoint); }
		void SetGeometryShader(VkShaderModule module, const char* entrypoint) { SetShaderStage(VK_SHADER_STAGE_GEOMETRY_BIT, module, entrypoint); }
		void SetFragmentShader(VkShaderModule module, const char* entrypoint) { SetShaderStage(VK_SHADER_STAGE_FRAGMENT_BIT, module, entrypoint); }
		...
		void AddVertexInputState(VkPipelineVertexInputStateCreateInfo input_state);
