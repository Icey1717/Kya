...
CameraObj_28* AllocateCameraObj28_002bae70(CameraObjParams* pParams, struct VidModeData_30* pVidModeDataA, struct VidModeData_30* pVidModeDataB, byte param_4);
