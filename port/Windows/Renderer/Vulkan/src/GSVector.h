...
public:
	...
	__forceinline uint32_t rgba32() const
	{
		GSVector4i v = *this;
	...
	template<int i> __forceinline int64_t extract64() const
	{
	...
	*/
	...
	__forceinline static GSVector4i loadq(int64_t i)
	{
	...
	__forceinline static int64_t storeq(const GSVector4i& v)
	{
...
public:
	...
	__forceinline explicit GSVector4(uint32_t u)
	{
		GSVector4i v((int)u);
	...
	__forceinline static GSVector4 rgba32(uint32_t rgba)
	{
		return GSVector4(GSVector4i::load((int)rgba).u8to32());
	}

	__forceinline static GSVector4 rgba32(uint32_t rgba, int shift)
	{
...
// NOTE: it's faster with shuffles...
	...
	__forceinline static GSVector4 load(uint32_t u)
	{
